...
const FormReserva = () => {
  ...
  // perdon mati toque tu codigo. atm
  const handlerReservaRecursos = (valor) => {
    //    console.log(valor)
    //   const newVal = valor.flat()
    // //  console.log(newVal)
    //   //const newRecursos = newReserva.recursos;
    //     const newRecursos = [...newReserva.recursos, ...valor.flat()];

    // //  console.log(newRecursos.flat());
    //    newRecursos.push(newVal);
    //    setNewReserva({ ...newReserva, recursos: newRecursos});
        ...
        <form onSubmit={handlerSubmit}>
          ...
          <div className="div_recursosReserva">
            ...
            {/* <Select
              ...
              placeholder="SELECCIONAR"
              size="large"
              onSelect={handlerReservaRecursos}
              value={null}
            >
          ...
          {/* <div>
            <ul className="alinearRecursosReserva">
              {newReserva?.recursos?.map((reserva, i) => (
                <li key={i} className="recursoReserva">
                  {reserva}
                </li>
              ))}
            </ul>
