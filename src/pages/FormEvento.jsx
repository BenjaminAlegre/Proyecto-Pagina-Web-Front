...
const FormEvento = () => {
  ...
  useEffect(() => {
    if (modoEdicion === true) {
      const horaInicio = `${String(stateEvento.horaInicio[0]).padStart(2, "0")}:
        ${String(stateEvento.horaInicio[1]).padStart(2, "0")}:
        ${String(stateEvento.horaInicio[2]).padStart(2, "0")}`;
      const horaFin = `${String(stateEvento.horaFin[0]).padStart(2, "0")}:
        ${String(stateEvento.horaFin[1]).padStart(2, "0")}:
        ${String(stateEvento.horaFin[2]).padStart(2, "0")}`;
      ...
      eventoAModificar = {
        ...
        horaInicio: dayjs(horaInicio, "HH:mm:ss"),
        horaFin: dayjs(horaFin, "HH:mm:ss"),
      ...
      if (
        ...
        eventoAModificar = {
          ...eventoAModificar,
          lugar: {
            provincia: stateEvento.lugar.provincia,
            localidad: stateEvento.lugar.localidad,
            direccion: stateEvento.lugar.direccion,
            piso: stateEvento.lugar.piso,
          },
        };

        habilitarLocalidad(stateEvento.lugar.provincia);
        setFiltro(stateEvento.lugar.localidad);
      }
  ...
  const handlerLugar = (name, value) => {
    setNewEvento({
      ...newEvento,
      lugar: { ...newEvento.lugar, [name]: value },
    });
  };
  //alrtas
  ...
  const confirmarSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 201 || response.status === 200) {
        const eventoCreated = response.data;
              ...
              <div className="div_ubiPresencial">
                <div className="">
                  ...
                  <Select
                    ...
                    value={newEvento.lugar.provincia}
                  >
                  ...
                  <p className="error">
                    {msjsValidaciones.lugar?.provincia &&
                      msjsValidaciones.lugar?.provincia._errors[0]}
                  </p>
                </div>
                <div className="">
                  ...
                  ></AutoComplete>
                  <p className="error">
                    {msjsValidaciones.lugar?.localidad &&
                      msjsValidaciones.lugar?.localidad._errors[0]}
                  </p>
                </div>
                <div className="">
                  ...
                  <CssTextField
                    ...
                    name="direccion"
                    size="small"
                    value={newEvento.lugar.direccion}
                    onChange={(e) =>
                  ...
                  />
                  <p className="error">
                    {msjsValidaciones.lugar?.direccion &&
                      msjsValidaciones.lugar?.direccion._errors[0]}
                  </p>
                </div>
                <div className="">
